...
namespace MatterOfTaste
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //любимый цвет компьютера  - red, green, blue
            //Компьютер просит ввестиназвание любимогоцвета пользователя.
            //Если введеный пользователем цвет совпадает с одним из любимых цветов компьютера,
            //компьютер выводит на экран "we are perfect together"
            //Если любимый цвет пользователя не совпадает с предпочтением компьютера
